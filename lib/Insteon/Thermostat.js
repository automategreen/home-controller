...
Thermostat.prototype.monitor = function (enable, next) {
  ...
  return this.insteon.scene(this.id, 'gw', {group: 0xFE, remove: true}, next);

};

Thermostat.prototype.handleCommand = function (cmd) {
  ...
  case '13':
    ...
    break;
  default:
      debug('No event for command - %s', cmd.standard.command1);
  }
